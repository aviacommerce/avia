defmodule Snitch.Repo.Migrations.CreateZoneTables do
  ...
  def change do
    ...
    create constraint("snitch_state_zone_members", :state_zone_exclusivity,
             check: "#{prefix() || "public"}.zone_exclusivity(zone_id, 'S') = 1"
           )

    create constraint("snitch_country_zone_members", :country_zone_exclusivity,
             check: "#{prefix() || "public"}.zone_exclusivity(zone_id, 'C') = 1"
           )
  end
end
