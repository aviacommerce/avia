...
var _user$project$StockLocations_ListItem$renderStatus = function (model) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(
				model.active ? 'badge badge-success' : 'badge badge-danger'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$StockLocations_ListItem$view = function (model) {
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('StockLocations__List__Item'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(model.sno)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('text-dark'),
								_1: {
									ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$StockLocations_ListItem$renderStatus(model),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-icon', 'edit'),
												_1: {ctor: '[]'}
											}
										}
									},
...
var _user$project$StockLocations_ListItem$Model = F4(
	function (a, b, c, d) {
		return {sno: a, id: b, name: c, active: d};
	});

var _user$project$StockLocations_List$renderStockLocation = function (stockLocation) {
	return _user$project$StockLocations_ListItem$view(stockLocation);
};
var _user$project$StockLocations_List$renderStockLocations = function (stockLocations) {
	return A2(
		_elm_lang$core$List$indexedMap,
		F2(
			function (i, x) {
				return _user$project$StockLocations_List$renderStockLocation(
...
var _user$project$StockLocations_List$stockLocationsDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$StockLocations_ListItem$Model,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'active', _elm_lang$core$Json_Decode$bool));
var _user$project$StockLocations_List$initialModel = {stockLocations: _krisajenkins$remotedata$RemoteData$Loading};
var _user$project$StockLocations_List$createErrorMessage = function (httpError) {
	var _p0 = httpError;
	switch (_p0.ctor) {
		case 'BadUrl':
			return _p0._0;
...
var _user$project$StockLocations_List$viewError = function (errorMessage) {
...
var _user$project$StockLocations_List$viewStockLocationsOrError = function (model) {
	var _p1 = model.stockLocations;
	switch (_p1.ctor) {
		case 'NotAsked':
		...
		case 'Success':
			return A2(
				...
				{ctor: '[]'},
				_user$project$StockLocations_List$renderStockLocations(_p1._0));
		default:
			return _user$project$StockLocations_List$viewError(
				_user$project$StockLocations_List$createErrorMessage(_p1._0));
	}
};
var _user$project$StockLocations_List$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$StockLocations_List$init = {
	ctor: '_Tuple2',
	_0: {stockLocations: _krisajenkins$remotedata$RemoteData$NotAsked},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$StockLocations_List$Model = function (a) {
	return {stockLocations: a};
};
var _user$project$StockLocations_List$DataReceived = function (a) {
	return {ctor: 'DataReceived', _0: a};
};
var _user$project$StockLocations_List$httpCommand = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$StockLocations_List$DataReceived,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(
			...
			A2(
				...
				_elm_lang$core$Json_Decode$list(_user$project$StockLocations_List$stockLocationsDecoder)))));
var _user$project$StockLocations_List$update = F2(
	function (msg, model) {
		var _p2 = msg;
		if (_p2.ctor === 'SendHttpRequest') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{stockLocations: _krisajenkins$remotedata$RemoteData$Loading}),
				_1: _user$project$StockLocations_List$httpCommand
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{stockLocations: _p2._0}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$StockLocations_List$SendHttpRequest = {ctor: 'SendHttpRequest'};

var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$initialModel = {stockLocationListModel: _user$project$StockLocations_List$initialModel};
var _user$project$Main$Model = function (a) {
	return {stockLocationListModel: a};
};
var _user$project$Main$StockLocationListMsg = function (a) {
	return {ctor: 'StockLocationListMsg', _0: a};
};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: _user$project$Main$initialModel,
	_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$StockLocationListMsg, _user$project$StockLocations_List$httpCommand)
};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var _p1 = A2(_user$project$StockLocations_List$update, _p0._0, model.stockLocationListModel);
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{stockLocationListModel: updatedModel}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$StockLocationListMsg, cmd)
		};
	});
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('elm-main'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				_user$project$Main$StockLocationListMsg,
				_user$project$StockLocations_List$view(model.stockLocationListModel)),
			_1: {ctor: '[]'}
		});
};
