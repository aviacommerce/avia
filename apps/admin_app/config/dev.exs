...
config :admin_app, AdminAppWeb.Endpoint,
  ...
  watchers: [
    ...
    esbuild:
      {Esbuild, :install_and_run, [:default, ~w(--sourcemap=inline --watch --loader:.js=jsx)]},
...
#     -subj "/C=US/ST=Denial/L=Springfield/O=Dis/CN=www.example.com" -keyout priv/server.key \
#     -out priv/server.pem
#
